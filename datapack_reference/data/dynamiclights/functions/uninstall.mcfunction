...
datapack disable "mod/dynamiclights"
datapack disable "file/dynamiclights-v1.9.1-mc1.17-1.21.11-datapack.zip"

say ⏻ Dynamic Lights v1.9.1 by Tschipcraft has been uninstalled by @s! It is safe to disable and remove the data pack/mod.
